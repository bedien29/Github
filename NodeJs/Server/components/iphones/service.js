...
const iphoneModel = require('./model');
...
exports.insert = async (iphone) => {
    const p = new categoryModel(iphone);
    await p.save();
}

exports.delete = async (id) => {
    // data = data.filter(item => item._id != id);
    await iphoneModel.findByIdAndDelete(id);
}

exports.update = async (id, iphone) => {
    await iphoneModel.findByIdAndUpdate(id, iphone);
}
